//Created By Md. Kamruzzaman (Tipu) 
//L293d Connection   
  const int motorA1  = 5;  // Pin  2 of L293d
  const int motorA2  = 6;  // Pin  7 of L293d
  const int motorB1  = 10; // Pin 10 of L293d
  const int motorB2  = 9;  // Pin 14 of L293d
//Fornt Leds connected to Arduino UNO Pin 12
  const int flights  = 12;
//Back Leds connected to Arduino UNO Pin 11
  const int blights = 11;
//Back Red leds connected to Arduino UNO Pin 7
  const int rlights = 7;
...
//     if(digitalRead(BTState)==LOW) { state='S'; }
  ...
  /************************Lights*****************************/
  //If state is equal with letter 'W', turn fornt leds on or off
    else if (state == 'W') 
    {  
   ...
   //If state is equal with letter 'U', turn back leds on or off
    else if (state=='U')
    {
